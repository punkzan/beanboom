// 
// Vendored from @resvg/resvg-wasm@2.6.2 index.mjs with one patch:
// __wbg_load instantiates synchronously via new WebAssembly.Instance()
// instead of async WebAssembly.instantiate(). On workerd (Cloudflare
// Pages) the async instantiate op hung forever in ~30% of isolates,
// tripping the hang detector (1101) and poisoning every request on
// that isolate. Sync instantiation of a build-time-compiled Module
// creates no async I/O operation.
// // wasm/dist/index.js
var wasm;
